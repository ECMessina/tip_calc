...
import 'package:tip_calc/form_fields.dart/amount_selector.dart';
import 'package:tip_calc/constants.dart';
import 'package:tip_calc/output_amount.dart';
import 'package:tip_calc/form_fields.dart/percent_selector.dart';
...
class _DataScreenState extends State<DataScreen> {
  ...
  final TextEditingController tipPercentageController = TextEditingController(
    text: kDefaultPercentTip.toString(),
  );
      ...
      child: Form(
        ...
        child: Column(
          ...
          children: [
            ...
            CalculateButton(onPressed: tipCalc),
            OutputAmount(
              label: 'TIP VALUE',
